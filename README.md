...
You can compile Swift sources using a container image such as `swift:6.3.3-noble`.
...
Then, copy the executable files into a `DockerSwiftApacheCombination` image which is, for example, tagged as `ghcr.io/yockow/swift-de-cgi:Swift_6.3.3-noble-latest`.
